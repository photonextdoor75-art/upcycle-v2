...
// On enlève "text-white" pour permettre au parent de définir la couleur (souvent text-gray-600 ou autre)
interface IconProps {
  className?: string;
}

export const LeafIcon: React.FC<IconProps> = ({ className = "h-6 w-6" }) => (
